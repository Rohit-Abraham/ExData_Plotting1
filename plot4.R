...
par(mfrow = c(2, 2))
with(subdata2, plot(datetime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
with(subdata2, plot(datetime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(subdata2, plot(datetime, Global_reactive_power, type = "l", xlab = "datetime", 
